...
- **M5 (in progress):** post-quantum **hybrid key encapsulation** (X25519 + ML-KEM-768) behind `CryptoSuite::Hybrid25519MlKem768`; multi-device and federation remain.
...
**networked presence-certificate collection**, Shamir sharing, the place-locked
end-to-end flow, and property-based invariants.
