...
The test suite currently passes **106 tests** covering AEAD, sealed boxes,
...
See [deploy/README.md](deploy/README.md). The relay holds ciphertext only; the
daemon holds the local identity's keys.
